...
"""
    ...
    NOYES_URL = "@robot URL detected.Get me a fast URL so that I can upload to Telegram, without me slowing down for other users."
    ...
    FF_MPEG_RO_BOT_AD_VER_TISE_MENT = "HMM"
    ...
    SLOW_URL_DECED = "Gosh that seems to be a very slow URL. Since you were screwing my home, I am in no mood to download this file. Meanwhile, get me a fast URL so that I can upload to Telegram, without me slowing down for other users."
